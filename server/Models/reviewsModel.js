...
let reviewsModel = {
  url: 'http://ec2-3-22-222-184.us-east-2.compute.amazonaws.com:3000/reviews',
  ...
  getMeta: ( params ) => {
    const options = {
      url: path.join('http://ec2-3-22-222-184.us-east-2.compute.amazonaws.com:3000/reviews', '/meta'),
      headers: reviewsModel.headers,
      params: params
